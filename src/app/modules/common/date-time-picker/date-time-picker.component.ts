    ...
    <div class="p-4 min-w-80">
      ...
      <div class="flex justify-center items-center space-x-2 mb-6">
        ...
        <div class="flex flex-col items-center">
          <button class="p-2 hover:bg-gray-100 rounded-full" (click)="incrementHours()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
            </svg>
          </button>
          <div class="w-8 text-center font-medium border-b-2 border-red-500">{{ hours }}</div>
          <button class="p-2 hover:bg-gray-100 rounded-full" (click)="decrementHours()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Minutes -->
        <div class="flex flex-col items-center">
          <button class="p-2 hover:bg-gray-100 rounded-full" (click)="incrementMinutes()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
            </svg>
          </button>
          <div class="w-8 text-center font-medium border-b-2 border-red-500">{{ minutes }}</div>
          <button class="p-2 hover:bg-gray-100 rounded-full" (click)="decrementMinutes()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
            </svg>
          </button>
        ...
        <!-- Seconds -->
        <div class="flex flex-col items-center">
          <button class="p-2 hover:bg-gray-100 rounded-full" (click)="incrementSeconds()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
            </svg>
          </button>
          <div class="w-8 text-center font-medium border-b-2 border-red-500">{{ seconds }}</div>
          <button class="p-2 hover:bg-gray-100 rounded-full" (click)="decrementSeconds()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
            </svg>
          </button>
  ...
  template: `
    <div class="relative">
      <mat-form-field [ngClass]="formFieldHelpers" class="w-full">
        ...
        <mat-datepicker (closed)="openTimePicker()" #picker></mat-datepicker>
      </mat-form-field>
    </div>
  `,
  styles: [`
...
export class DatetimePickerComponent implements ControlValueAccessor {
  ...
  openTimePicker(): void {
    ...
    // ตั้งค่าเวลาปัจจุบัน
    const timePickerInstance = dialogRef.componentInstance as TimePickerDialogComponent;
