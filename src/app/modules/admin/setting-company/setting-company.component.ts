...
export class SettingCompanyComponent implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        private _Service: SettingCompanyService,
        ...
        this.form = this.formBuilder.group({
            ...
            title_box: this.data.title_box,
            body_box: this.data.body_box,
            footer_box: this.data.footer_box,
