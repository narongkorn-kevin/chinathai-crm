...
@Component({
    selector: 'app-point-record-detail',
    standalone: true,
    imports: [
        CommonModule,
        DataTablesModule,
    ...
    templateUrl: './point-record-detail.component.html',
    changeDetection: ChangeDetectionStrategy.Default,
})
export class PointRecordDetailComponent implements OnInit, AfterViewInit {
    ...
    constructor(
        private readonly _service: PointRecordService,
