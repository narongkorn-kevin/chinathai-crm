...
import { TrackingDialogComponent } from './tacking-dialog/tracking-dialog.component';

@Component({
    selector: 'app-stock-po-edit-detail',
    standalone: true,
    imports: [
        CommonModule,
        DataTablesModule,
...
export class DetailComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    openDialogProduct() {
        ...
        // หลังจาก dialog ถูกปิด ให้ตรวจสอบผลลัพธ์และ rerender ตารางถ้ามีการเปลี่ยนแปลง
