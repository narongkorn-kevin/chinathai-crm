...
export class ShippingRatesService {
    ...
    update(id: any,data: any) {
        return this.http.put('/api/transport_rate/' + id, data)
    }
    ...
    getTransportType() {
        return this.http.get('/api/get_transport_type').pipe(
            tap((resp: any) => {
                this._roles.next(resp);
            })
        );
    ...
    getById(id: string) {
        return this.http.get('/api/transport_rate/' + id).pipe(
            tap((resp: any) => {
                this._data.next(resp);
            })
        );
    ...
    datatable(dataTablesParameters: any) {
        return this.http.post('/api/transport_rate_page', dataTablesParameters).pipe(
            map((resp: any) => {
                return resp;
            })
        );
    ...
    create(data: any) {
        return this.http.post(
            environment.apiUrl + '/api/transport_rate',
            data
        );
    }
