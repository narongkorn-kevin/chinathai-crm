...
export class ShippingRatesComponent implements OnInit, AfterViewInit {
    dtOptions: any = {};
    ...
    constructor(
        ...
        private _service: ShippingRatesService,
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                if (this.filterForm.value.name) {
                    dataTablesParameters.name = this.filterForm.value.name;
                }
            ...
            columns: [
                ...
                {
                    title: menuTitles.shipping_rate_code[this.langues],
                    data: 'code',
                ...
                {
                    title: menuTitles.name[this.langues],
                    data: 'name',
                    className: 'text-center',
                },
                {
    ...
    openForm() {
        this._router.navigate(['shipping-rates/form']);
    }
