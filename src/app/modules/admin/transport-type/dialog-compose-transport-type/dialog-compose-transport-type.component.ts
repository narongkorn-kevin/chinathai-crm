...
@Component({
    selector: 'dialog-compose-transport-type-component',
    standalone: true,
    templateUrl: './dialog-compose-transport-type.component.html',
    imports: [
        CommonModule,
        MatIconModule,
        MatFormFieldModule,
...
export class DialogComposeTransportTypeComponent implements OnInit {

    form: FormGroup;
    formFieldHelpers: string[] = ['fuse-mat-dense'];

    constructor(
        private dialogRef: MatDialogRef<DialogComposeTransportTypeComponent>,
        @Inject(MAT_DIALOG_DATA) public data: { action: 'NEW' | 'EDIT' },
        public dialog: MatDialog,
        private FormBuilder: FormBuilder,
        public _service: TransportTypeService,
        private fuseConfirmationService: FuseConfirmationService,
        private toastr: ToastrService,
        private userService: UserService,
        private memberService: TransportTypeService,
