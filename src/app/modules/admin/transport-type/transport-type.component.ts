...
import { DialogComposeTransportTypeComponent } from './dialog-compose-transport-type/dialog-compose-transport-type.component';
...
export class TransportTypeComponent implements OnInit, AfterViewInit {
    dtOptions: any = {};
    ...
    openDialogAdd() {
        this.dialog.open(DialogComposeTransportTypeComponent, {
            width: '50%',
            data: {
                action: 'NEW'
            }
