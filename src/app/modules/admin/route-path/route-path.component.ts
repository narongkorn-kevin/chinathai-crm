...
import { DialogComposeRoutePathComponent } from './dialog-compose-route-path/dialog-compose-route-path.component';
...
export class RoutePathComponent implements OnInit, AfterViewInit {
    dtOptions: any = {};
    ...
    constructor(
        private _service: RoutePathService,
    ...
    openDialogAdd() {
        this.dialog.open(DialogComposeRoutePathComponent, {
            width: '50%',
            data: {
                action: 'NEW'
            }
