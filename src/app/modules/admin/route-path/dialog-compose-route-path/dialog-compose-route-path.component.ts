...
@Component({
    selector: 'dialog-compose-route-path-component',
    standalone: true,
    templateUrl: './dialog-compose-route-path.component.html',
    imports: [
        CommonModule,
        MatIconModule,
        MatFormFieldModule,
...
export class DialogComposeRoutePathComponent implements OnInit {

    form: FormGroup;
    formFieldHelpers: string[] = ['fuse-mat-dense'];

    constructor(
        private dialogRef: MatDialogRef<DialogComposeRoutePathComponent>,
        @Inject(MAT_DIALOG_DATA) public data: { action: 'NEW' | 'EDIT' },
        public dialog: MatDialog,
        private FormBuilder: FormBuilder,
        public _service: RoutePathService,
        private fuseConfirmationService: FuseConfirmationService,
        private toastr: ToastrService,
        private userService: UserService,
        private memberService: RoutePathService,
