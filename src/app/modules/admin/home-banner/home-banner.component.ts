...
import { DialogComposeHomeBannerComponent } from './dialog-compose-home-banner/dialog-compose-home-banner.component';
...
export class HomeBannerComponent implements OnInit, AfterViewInit {
    ...
    constructor(
        private _service: HomeBannerService,
    ...
    openDialogAdd() {
        this.dialog.open(DialogComposeHomeBannerComponent, {
            width: '50%',
            data: {
                action: 'NEW'
            }
