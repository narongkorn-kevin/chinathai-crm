...
@Component({
    ...
    standalone: true,
    templateUrl: './dialog-compose-vendor.component.html',
    imports: [
        CommonModule,
        MatIconModule,
        MatFormFieldModule,
...
export class DialogComposeVendorComponent implements OnInit {

    form: FormGroup;
    formFieldHelpers: string[] = ['fuse-mat-dense'];

    constructor(
        private dialogRef: MatDialogRef<DialogComposeVendorComponent>,
        @Inject(MAT_DIALOG_DATA) public data: { action: 'NEW' | 'EDIT' },
        public dialog: MatDialog,
        private FormBuilder: FormBuilder,
        public _service: VendorService,
        private fuseConfirmationService: FuseConfirmationService,
        private toastr: ToastrService,
        private userService: UserService,
        private memberService: VendorService,
