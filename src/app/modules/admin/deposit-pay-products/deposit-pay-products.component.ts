...
@Component({
    ...
    templateUrl: './deposit-pay-products.component.html',
    styleUrl: './deposit-pay-products.component.scss',
    changeDetection: ChangeDetectionStrategy.Default,
})
export class DepositPayProductsComponent implements OnInit, AfterViewInit {
    dtOptions: any = {};
