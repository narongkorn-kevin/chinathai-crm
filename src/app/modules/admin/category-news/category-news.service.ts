...
export class CategoryNewsService {
    ...
    get(id: number) {
        return this.http.get(environment.apiUrl + '/api/category_news/' + id,)
    }

    create(data: any) {
        return this.http.post(environment.apiUrl + '/api/category_news', data)
    }
    ...
    update(id: any, data: any) {
        ...
        return this.http.post(environment.apiUrl + '/api/update_category_news', body)
    }

    delete(id: number) {
        return this.http.delete(environment.apiUrl + '/api/category_news/' + id)
    }
}
