...
import { DialogComposePackagingComponent } from './dialog-compose-packaging/dialog-compose-packaging.component';
...
export class PackagingComponent implements OnInit, AfterViewInit {
    dtOptions: any = {};
    ...
    constructor(
        private _service: PackagingService,
