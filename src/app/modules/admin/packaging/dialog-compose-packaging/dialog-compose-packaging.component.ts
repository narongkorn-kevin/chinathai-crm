...
@Component({
    selector: 'dialog-compose-packaging-component',
    standalone: true,
    templateUrl: './dialog-compose-packaging.component.html',
    imports: [
        CommonModule,
        MatIconModule,
        MatFormFieldModule,
...
export class DialogComposePackagingComponent implements OnInit {
    ...
    constructor(
        ...
        private memberService: PackagingService,
