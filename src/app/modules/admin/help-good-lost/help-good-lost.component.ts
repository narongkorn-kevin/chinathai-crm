...
import { HelpGoodLostService } from './help-good-lost.service';
@Component({
    selector: 'app-help-good-lost-device',
    standalone: true,
    imports: [
        CommonModule,
        DataTablesModule,
    ...
    templateUrl: './help-good-lost.component.html',
    styleUrl: './help-good-lost.component.scss',
    changeDetection: ChangeDetectionStrategy.Default,
})
export class HelpGoodLostComponent implements OnInit, AfterViewInit {
    ...
    constructor(
        private _service: HelpGoodLostService,
