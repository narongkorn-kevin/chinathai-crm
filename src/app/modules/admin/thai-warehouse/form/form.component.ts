...
export class FormComponent implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        if (this.type === 'EDIT') {
            ...
            const deliveryOrderLists = this.data.delivery_orders.map(
                (order) => ({
                    ...
                    barcode: order.delivery_order?.po_no,
    ...
    get totalWeight() {
        return this.form
            ...
            .value.reduce((total, item) => total + Number(item.weight), 0)
            .toFixed(4);
    }
    get totalCBM() {
        return this.form
