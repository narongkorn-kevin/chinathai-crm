...
import { DialogComposeThaiWarehouseComponent } from './dialog-compose-thai-warehouse/dialog-compose-thai-warehouse.component';
...
@Component({
    ...
    templateUrl: './setting-thai-warehouse.component.html',
    changeDetection: ChangeDetectionStrategy.Default,
})
export class SettingThaiWarehouseComponent implements OnInit, AfterViewInit {
    dtOptions: any = {};
    ...
    constructor(
        private _service: SettingThaiWarehouseService,
    ...
    openDialogAdd() {
        this.dialog.open(DialogComposeThaiWarehouseComponent, {
            width: '50%',
            data: {
                action: 'NEW'
            }
