...
import { SettingThaiWarehouseService } from '../setting-thai-warehouse.service';

@Component({
    selector: 'dialog-compose-thai-warehouse-component',
    standalone: true,
    templateUrl: './dialog-compose-thai-warehouse.component.html',
    imports: [
        CommonModule,
        MatIconModule,
        MatFormFieldModule,
...
export class DialogComposeThaiWarehouseComponent implements OnInit {

    form: FormGroup;
    formFieldHelpers: string[] = ['fuse-mat-dense'];

    constructor(
        private readonly dialogRef: MatDialogRef<DialogComposeThaiWarehouseComponent>,
        @Inject(MAT_DIALOG_DATA) public data: { action: 'NEW' | 'EDIT' },
        public dialog: MatDialog,
        private readonly FormBuilder: FormBuilder,
        public _service: SettingThaiWarehouseService,
        private readonly fuseConfirmationService: FuseConfirmationService,
        private readonly toastr: ToastrService,
        private readonly memberService: SettingThaiWarehouseService,
    ) {
